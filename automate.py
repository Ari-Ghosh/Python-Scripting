...
def automate(self):
    ...
    for i in range(2, num_rows + 1):
        if sheet.cell(i, 7).value == 'unsent':
            ...
            app = Application(backend='uia').start("../Form/Form.exe")
            ...
            Maximize = app.PatientInformationForm.child_window(title="System",
                                                               control_type="MenuItem").wrapper_object()
            Maximize.click_input()

            x2, y2 = auto.locateCenterOnScreen("../assets/name.png", confidence=0.9)
            auto.moveTo(x2, y2, 1)
            auto.click()
            time.sleep(1)
            auto.write(name)

            x3, y3 = auto.locateCenterOnScreen("../assets/address.png", confidence=0.9)
            auto.moveTo(x3, y3, 1)
            auto.click()
            time.sleep(1)
            auto.write(address)

            x4, y4 = auto.locateCenterOnScreen("../assets/nhs.png", confidence=0.9)
            auto.moveTo(x4, y4, 1)
            auto.click()
            time.sleep(1)
            auto.write(nhs_no)

            x5, y5 = auto.locateCenterOnScreen("../assets/ph.png", confidence=0.9)
            auto.moveTo(x5, y5, 1)
            auto.click()
            time.sleep(1)
            auto.write(ph_no)

            x6, y6 = auto.locateCenterOnScreen("../assets/dob.png", confidence=0.9)
            auto.moveTo(x6, y6, 1)
            auto.click()
            time.sleep(1)
            auto.write(dob)

            x7, y7 = auto.locateCenterOnScreen("../assets/dropdown.png", confidence=0.9)
            auto.moveTo(x7, y7, 1)
            auto.click()
            time.sleep(1)

            if sex == ' Male':
                x71, y71, width, height = auto.locateOnScreen("../assets/male.png", confidence=0.9)
                auto.moveTo(x71, y71, 1)
                auto.click()
                time.sleep(1)
            if sex == ' Female':
                x72, y72, width, height = auto.locateOnScreen("../assets/female.png",
                                                              confidence=0.9)
                auto.moveTo(x72, y72, 1)
                auto.click()
                time.sleep(1)
            if sex == ' Trans':
                x73, y73, width, height = auto.locateOnScreen("../assets/trans.png",
                                                              confidence=0.9)
                auto.moveTo(x73, y73, 1)
                auto.click()
                time.sleep(1)

            x8, y8 = auto.locateCenterOnScreen("../assets/submit.png", confidence=0.9)
            auto.moveTo(x8, y8, 1)
            auto.click()
            time.sleep(1)

            Maximize = app.PatientInformationForm.child_window(title="Close",
